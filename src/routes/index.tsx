          ...
          <div className="mx-auto grid max-w-[1440px] gap-12 lg:grid-cols-[.52fr_1.48fr] lg:gap-20">
            ...
            <div>
              ...
              <div className="mt-12 grid gap-x-12 gap-y-8 border-t border-border pt-8 text-base leading-8 text-ink-soft md:grid-cols-2 md:text-lg">
                <p>Hi, I’m Anvitha Reddy, a Data Science & Analytics graduate with a Computer Science background. I enjoy working at the intersection of data, technology, and real-world problem solving.</p>
                <p>My work spans analytics, machine learning, forecasting, research, and technical problem solving. I like taking complex questions from exploration through evaluation and turning the results into something useful—whether that’s a predictive model, an analysis, a dashboard, or a clearer decision.</p>
                ...
                <p>I’m especially interested in work where strong analysis can move beyond a notebook and influence a product, process, or decision.</p>
              </div>
